...
int main() {
    ...
    sector_t s1 = R_CreateSector(10, 0, 0xd6382dff, 0xf54236ff, 0x9c2921ff);
    sector_t s2 = R_CreateSector(20, 0, 0xd6382dff, 0xf54236ff, 0x9c2921ff);
    sector_t s3 = R_CreateSector(30, 0, 0xd6382dff, 0xf54236ff, 0x9c2921ff);
    sector_t s4 = R_CreateSector(40, 0, 0xd6382dff, 0xf54236ff, 0x9c2921ff);

    sector_t s5 = R_CreateSector(80, 0, 0x29ba48ff, 0x43f068ff, 0x209138ff);
    sector_t s6 = R_CreateSector(80, 0, 0x29ba48ff, 0x43f068ff, 0x209138ff);
    sector_t s7 = R_CreateSector(80, 0, 0x29ba48ff, 0x43f068ff, 0x209138ff);

    sector_t s8 = R_CreateSector(80, 0, 0x29ba48ff, 0xd43f068f, 0x209138ff);
    sector_t s9 = R_CreateSector(80, 0, 0x29ba48ff, 0xd43f068f, 0x209138ff);
    sector_t s10 = R_CreateSector(80, 0, 0x29ba48ff, 0xd43f068f, 0x209138ff);

    sector_t s11 = R_CreateSector(30, 0, 0xa3a24bff, 0xd9d764ff, 0x858338ff);
    sector_t s12 = R_CreateSector(30, 0, 0xa3a24bff, 0xd9d764ff, 0x858338ff);

    sector_t s13 = R_CreateSector(10, 0, 0xa3a24bff, 0xd9d764ff, 0x858338ff);
    sector_t s14 = R_CreateSector(10, 0, 0xa3a24bff, 0xd9d764ff, 0x858338ff);
    sector_t s15 = R_CreateSector(30, 10, 0xa3a24bff, 0xd9d764ff, 0x858338ff);
    sector_t s16 = R_CreateSector(30, 10, 0xa3a24bff, 0xd9d764ff, 0x858338ff);
